            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    <div class="section-header-button mb-3">
                        <a href="/guru/peminjaman" class="btn btn-outline-primary">Kembali</a>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="/guru/tambah_peminjaman" method="post" autocomplete="off">
                                <!-- <input type="hidden" name="_method" value="PUT"> -->
                                <div class="form-group">
                                    <label for="kode_peminjaman">Kode Peminjaman *</label>
                                    <input type="text" name="kode_peminjaman" class="form-control" value="<?= $newKodePeminjaman; ?>" readonly required>
                                </div>
                                <div class="form-group">

...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/guru/stok_barang">Stok Barang</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Peminjaman Barang -->
            <li class="nav-item">
                <a class="nav-link" href="/guru/peminjaman">
            ...
            <!-- Pengembalian Barang -->
            <li class="nav-item">
                <a class="nav-link" href="/guru/pengembalian">
    ...
    <script>
        // mengambil Flashdata dari controller
        ...
        document.getElementById("formPeminjaman").addEventListener("submit", function(event) {
            ...
            var url = "/guru/peminjaman/" + selectedOption;

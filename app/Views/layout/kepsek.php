...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/kepsek/stok_barang">Stok Barang</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Peminjaman Barang -->
            <li class="nav-item">
                <a class="nav-link" href="/kepsek/laporan_peminjaman">
            ...
            <!-- Pengembalian Barang -->
            <li class="nav-item">
                <a class="nav-link" href="/kepsek/laporan_pengembalian">
            ...
            <li class="nav-item">
                ...
                <div id="laporan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Menu :</h6>
                        <a class="collapse-item" href="/kepsek/laporan_barang_masuk">Laporan Barang Masuk</a>
                        <a class="collapse-item" href="/kepsek/laporan_barang_keluar">Laporan Barang Keluar</a>
                    </div>
                </div>
            </li>

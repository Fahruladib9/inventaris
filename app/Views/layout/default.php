...
<head>
    ...
    <meta name="keywords" content="inventaris, sistem inventaris, sdn 13 sumber marga telang, inventory">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Data Suplier -->
            <li class="nav-item">
                <a class="nav-link" href="/data_suplier">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/stok_barang">Stok Barang</a>
                        <a class="collapse-item" href="/jenis_barang">Jenis Barang</a>
                        <a class="collapse-item" href="/satuan_barang">Satuan</a>
                        <a class="collapse-item" href="/kondisi_barang">Kondisi</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="laporan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Menu :</h6>
                        <a class="collapse-item" href="/laporan_barang_masuk">Laporan Barang Masuk</a>
                        <a class="collapse-item" href="/laporan_barang_keluar">Laporan Barang Keluar</a>
                    </div>
                </div>
            </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/logout">Yakin</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // untuk view barang keluar
        document.getElementById("formBarangKeluar").addEventListener("submit", function(event) {
